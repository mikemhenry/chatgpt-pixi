...
- Add upstream GitHub release, archive checksum, and SLSA attestation verification.
- Fetch and verify Pixi's attested tar.gz release archive rather than expecting the raw binary in a global `sha256.sum`.
